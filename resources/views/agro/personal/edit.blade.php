<x-app-layout>
  <x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
      {{ __('Edición Contacto Agro') }} - {{ $personal->agro_id }}
    </h2>
  </x-slot>
  <div class="py-4">
      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-2 text-gray-900 text-left ">
          <div class="sm:flex-1 sm:flex sm:items-center sm:justify-stretch">
            <form action="{{ route('agro_personal.update', $personal) }}" method="POST" class="personal__form">
              @csrf
              @method('put')
              ...
              <div class="personal__div">
                ...
                <input type="hidden" name="agro_id" id="agro_id" value="{{ $personal->agro_id }}">
              ...
              <div class="personal__btn">
                ...
                <div class="btn__cancelar">
                  <a class="btn__acancelar" href="{{ route('agro.show', ['agro' => $personal->agro_id]) }}">Cancelar</a>
