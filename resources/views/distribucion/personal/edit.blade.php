<x-app-layout>
  <x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
      {{ __('Edición Contacto Distribución') }} - {{ $personal->distribucion_id }}
    </h2>
  </x-slot>
  <div class="py-4">
      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-2 text-gray-900 text-left ">
          <div class="sm:flex-1 sm:flex sm:items-center sm:justify-stretch">
            <form action="{{ route('distribucion_personal.update', $personal->id) }}" method="POST" class="personal__form">
              @csrf
              @method('put')
              ...
              <div class="personal__div">
                ...
                <input type="hidden" name="distribucion_id" id="distribucion_id" value="{{ $personal->distribucion_id }}">
              </div>
              ...
              <div class="personal__div">
                ...
                <select class="form-select" name="area_id" id="single-select-field" data-placeholder="Seleccione una opcion">
                  <option></option>
              ...
              <div class="personal__btn">
                ...
                <div class="btn__cancelar">
                  <a class="btn__acancelar" href="{{route('distribucion.show',  ['distribucion' => $personal->distribucion_id]) }}">Cancelar</a>
