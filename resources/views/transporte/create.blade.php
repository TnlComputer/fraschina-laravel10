      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-2 text-gray-900 text-left ">
          <div class=" sm:flex-1 sm:flex sm:items-center sm:justify-stretch">
            <form action="{{ route('transporte.store') }}" method="post" class="card__form" enctype="multipart/form-data">
              @csrf
              <div class="card__div">
              ...
              <div class="card__div">
                <label class="card__label" for="dire_obs">Dirección Observaciones</label>
                <input class="card__input" type="text" name="dire_obs" id="dire_obs" value="">
              </div>
