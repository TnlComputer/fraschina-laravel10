<x-app-layout>
  <x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
      {{ __('Nuevo Contacto Transporte') }} - {{ $transporte->id}}
    </h2>
  </x-slot>
  <div class="py-4">
      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-2 text-gray-900 text-left ">
          <div class="sm:flex-1 sm:flex sm:items-center sm:justify-stretch">
            <form action="{{ route('transporte_personal.store') }}" method="POST" class="personal__form">
              @csrf
              <div class="personal__div">
                ...
                <input type="hidden" name="transporte_id" id="transporte_id" value="{{ $transporte->id }}">
              ...
              <div class="personal__div">
                ...
                <select class="from-select" name="area_id" id="single-select-field" data-placeholder="Seleccione un Area" required>
                  <option></option>
              ...
              <div class="personal__btn">
                ...
                <div class="btn__cancelar">
                  <a class="btn__acancelar" href="{{ route('transporte.show', ['transporte' => $transporte->id]) }}">Cancelar</a>
