...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/distribucion/producto/{representacion_producto}', [DistribucionProductoController::class, 'edit'])->name('distribucion_producto.edit');
    Route::patch('/distribucion/producto/{representacion_prodcuto}', [DitribucionProductoController::class, 'update'])->name('distribucion_producto.update');
